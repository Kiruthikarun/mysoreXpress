...
const FooterWithPlayer = () => {
      ...
      <footer className="bg-black text-gray-400 pt-12 sm:pt-16 pb-20 sm:pb-24">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mb-4 text-sm sm:text-base font-[Montserrat] font-bold">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base font-[Montserrat]">
              <li>
                <a
                  href="/music"
              ...
              <li>
                <a href="contact" className="hover:text-[#ff4a4a] transition-colors">
                  Contact
                </a>
              </li>
            </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 pt-6 sm:pt-8 mt-6 sm:mt-8 border-t border-gray-800 font-origin">
          ...
          <p className="text-center text-xs sm:text-sm mt-2 font-origin">
  ...
  <a 
    ...
    className="inline-block ml-2 text-red-600 hover:text-red-500 font-[Montserrat] font-bold text-lg relative group"
  >
    tmmc.ai
