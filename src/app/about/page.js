...
import { Music, Disc2, Videotape } from "lucide-react";
...
const AboutPage = () => {
  ...
  <Image
    src="/images/heroabt.jpg"
    alt="Band performing"
    layout="fill"
    objectFit="cover"
    objectPosition="center"
    placeholder="blur"
    blurDataURL="/images/compressed/heroabt.jpg" // Add a low-res blurred version of the image here
    className="opacity-60"
  />
  
  <div className="absolute inset-0 flex items-center justify-center z-20">
    <div className="text-center">
      <Disc2 className="w-16 h-16 mx-auto mb-4 font-light text-[#ff4a4a]" />
      <h1 className="text-4xl md:text-4xl font-origin text-[#ff4a4a] mb-4">
        About Us
      </h1>
    </div>
  </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div ref={textRef} className="space-y-6">
              ...
              <div className="space-y-4 font-[Montserrat] font-bold text-gray-300">
